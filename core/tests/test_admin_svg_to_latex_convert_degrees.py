...
class AdminSvgToLatexConvertDegreesTests(TestCase):
    def setUp(self):
        self.admin = User.objects.create_user(username="admin", password="pass", role="admin")
        self.client.login(username="admin", password="pass")

    def test_converts_degrees_words_even_without_svg(self):
        ...
        html = "<p>∠BAC = 26градусов. Ответ дайте в граду- сах.</p>"
        ...
        self.assertNotIn("градусов", v.content.lower())
        self.assertNotIn("граду-", v.content.lower())
