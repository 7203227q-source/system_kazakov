...
class StudentSolveAssignmentAIFeedbackHtmlRenderTests(TestCase):
    def test_ai_feedback_html_is_rendered_not_escaped(self):
        ...
        assignment = Assignment.objects.create(tutor=tutor, student=student, title="A", is_draft=False, exam_format=ef)
        ...
        sub.primary_score = 2
        sub.ai_feedback = "<ul><li><b>Что верно:</b><br>OK</li></ul>"
        sub.save()
        ...
        self.assertContains(page, "<ul>", html=False)
